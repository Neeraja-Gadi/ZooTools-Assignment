...
//   // Display all data or only the top 4 based on showAll state
//   const visibleData = showAll ? sortedData : sortedData.slice(0, 4);

//   return (
//     <Card elevation={3} style={{ marginBottom: '20px',}}>
//       <CardContent>
//         <Typography variant="h6" fontStyle = "bold" style={{ marginBottom: '5px' }}>
//           {title}
//         </Typography>
//         <Table>
//           <TableHead>
...
//                 <TableCell align="center">{item.friendsInvited}</TableCell>
